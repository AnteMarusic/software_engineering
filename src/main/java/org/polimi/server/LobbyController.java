...
public class LobbyController {
    ...
    private synchronized void createGame(int gameMode){
        switch (gameMode) {
            case 2-> {
            ...
            case 4-> {
                ...
                publicListOf4.removeAll(publicListOf4);
            }
        }
    }
}
