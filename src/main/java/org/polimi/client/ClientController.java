...
public class ClientController {
    ...
    public void chooseCards() {
        ...
        while (counter < maxInsertable) {
            //chooses cards and controls if are in bound, are pickable and are alligned;
        }
            ...
            switch(counter){
                case 0 -> {
                    do {
                        ...
                        if (GameRules.boardRowColInBound(previousX, previousY, gameEnv.getNumOfPlayers())) {
                            coordinates = new Coordinates(previousX, previousY);
                            tempCard = gameEnv.boardSeeCardAtCoordinates(coordinates);
                            if (tempCard == null)
                                ...
                                if(tempCard.getState() == Card.State.NOT_PICKABLE)
                                    ...
                                    chosenCards.add(GameEnv.getCardAtCoordinates(coordinates));
                                    counter++;
