...
//                    grid[row + 1][col].getColor() == grid[row][col].getColor()) {    // giù e dx
//                return 2 + countSnake(row, col + 1) + countSnake(row + 1, col);
//            }
//            if (!visited.contains(new Coordinates(row, col + 1)) && grid[row][col+1]!= null &&
//                    grid[row][col + 1].getColor() == grid[row][col].getColor()){     // solo dx
//
//                return 1 + countSnake(row, col + 1);
//            }
//            if (!visited.contains(new Coordinates(row + 1, col)) && grid[row+1][col]!= null &&
//                    grid[row + 1][col].getColor().equals(grid[row][col].getColor())){   // solo giù
//                return 1 + countSnake(row + 1, col);
//            }
//        }
//        if (row == 0 && col == 4){ // giù, sx
//            if(!visited.contains(new Coordinates(row + 1, col)) && grid[row+1][col]!= null &&
//                    grid[row + 1][col].getColor() == grid[row][col].getColor() &&
//                    !visited.contains(new Coordinates(row, col - 1)) && grid[row][col - 1] != null &&
//                    grid[row][col - 1].getColor() == grid[row][col].getColor()){  // giù e sx
//                return 2 + countSnake(row, col-1) + countSnake(row + 1, col);
//            }
//            if (!visited.contains(new Coordinates(row + 1, col)) && grid[row+1][col]!= null &&
//                    grid[row + 1][col].getColor() == grid[row][col].getColor()) {  // solo giù
//                return 1 + countSnake(row + 1, col);
//            }
//            if (!visited.contains(new Coordinates(row, col - 1)) && grid[row][col - 1] != null &&
//                    grid[row][col - 1].getColor() == grid[row][col].getColor()) {  // solo sx
//
//                return 1 + countSnake(row, col - 1);
//            }
//        }
...
//                    grid[row - 1][col].getColor() == grid[row][col].getColor() &&
//                    !visited.contains(new Coordinates(row, col - 1)) && grid[row][col - 1] != null &&
//                    grid[row][col - 1].getColor() == grid[row][col].getColor()){  // su e sx
//                return 2 + countSnake(row, col-1) + countSnake(row - 1, col);
//            }
//            if (!visited.contains(new Coordinates(row - 1, col)) && grid[row-1][col]!= null &&
//                    grid[row - 1][col].getColor() == grid[row][col].getColor()) {  // solo su
//                return 1 + countSnake(row - 1, col);
//            }
//            if (!visited.contains(new Coordinates(row, col - 1)) && grid[row][col - 1] != null &&
//                    grid[row][col - 1].getColor() == grid[row][col].getColor()) {  // solo sx
...
//                    grid[row + 1][col].getColor() == grid[row][col].getColor() &&
//                    !visited.contains(new Coordinates(row, col - 1)) && grid[row][col - 1] != null &&
//                    grid[row][col - 1].getColor() == grid[row][col].getColor()){    // sia basso che dx che sx
//                return 3 + countSnake(row, col-1) + countSnake(row, col + 1) + countSnake(row + 1, col);
//            }
//
//            if (!visited.contains(new Coordinates(row, col + 1)) && grid[row][col+1]!= null && grid[row+1][col]!= null &&
//                    grid[row][col + 1].getColor() == grid[row][col].getColor() &&
//                    !visited.contains(new Coordinates(row + 1, col)) &&
//                    grid[row + 1][col].getColor() == grid[row][col].getColor()) {    // sia basso che dx
//                return 2 + countSnake(row, col + 1) + countSnake(row + 1, col);
//            }
//
//            if(!visited.contains(new Coordinates(row + 1, col)) && grid[row+1][col]!= null &&
...
//                    grid[row][col + 1].getColor() == grid[row][col].getColor() &&
//                    !visited.contains(new Coordinates(row, col - 1)) && grid[row][col - 1] != null &&
//                    grid[row][col - 1].getColor() == grid[row][col].getColor()) { // controllo dx e sx
//
//                return 2 + countSnake(row, col-1) + countSnake(row, col + 1);
//            }
//
...
//                    grid[row - 1][col].getColor() == grid[row][col].getColor() &&
//                    !visited.contains(new Coordinates(row, col - 1)) && grid[row][col - 1] != null &&
//                    grid[row][col - 1].getColor() == grid[row][col].getColor()){    // sia su che dx che sx
//                return 3 + countSnake(row, col-1) + countSnake(row, col + 1) + countSnake(row - 1, col);
//            }
//
//            if (!visited.contains(new Coordinates(row, col + 1)) && grid[row][col+1]!= null && grid[row-1][col]!= null &&
//                    grid[row][col + 1].getColor() == grid[row][col].getColor() &&
//                    !visited.contains(new Coordinates(row - 1, col)) &&
//                    grid[row - 1][col].getColor() == grid[row][col].getColor()) {    // sia su che dx
//                return 2 + countSnake(row, col + 1) + countSnake(row - 1, col);
//            }
//
//            if(!visited.contains(new Coordinates(row - 1, col)) && grid[row-1][col]!= null &&
...
//
//            }
//            if (!visited.contains(new Coordinates(row -1, col)) && grid[row-1][col]!= null && grid[row+1][col]!= null &&
//                    grid[row-1][col].getColor() == grid[row][col].getColor() &&
//                    !visited.contains(new Coordinates(row + 1, col)) &&
//                    grid[row + 1][col].getColor() == grid[row][col].getColor()) {    // giù e su
//                return 2 + countSnake(row-1, col) + countSnake(row + 1, col);
//            }
//
//
...
//                    grid[row][col + 1].getColor() == grid[row][col].getColor() &&
//                    !visited.contains(new Coordinates(row - 1, col)) &&
//                    grid[row - 1][col].getColor() == grid[row][col].getColor()) {    // su e dx
//                return 2 + countSnake(row, col + 1) + countSnake(row - 1, col);
//            }
//
//            if (!visited.contains(new Coordinates(row - 1, col)) && grid[row-1][col]!= null &&
